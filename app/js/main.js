...
$(function () {
  ...
  document.querySelectorAll(".accordeon__item-title").forEach((title) => {
    title.addEventListener("click", function () {
      const currentItem = this.closest(".accordeon__item");
      const currentContent = currentItem.querySelector(".accordeon__item-content");

      const allItems = document.querySelectorAll(".accordeon__item");
